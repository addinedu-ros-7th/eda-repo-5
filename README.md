...
| 팀원 | 최희재 | 구체적인 목표 설정, 문서 작성의 중요성을 느꼈습니다. 각자 잘하는 부분에 집중할 수 있다는 점에서 <br> 협업의 장점을 느꼈습니다.|
| 팀원 | 김완섭 | 비전공자로써 두려움과 걱정이 앞섰지만, 팀원들과 협업하여 결과물을 만들어 내니, <br> 협업의 중요함과 성취감을 느꼈습니다. |
| 팀원 | 조성현 | 프로젝트 초반에는 협업보다는 각자 개인의 역량이 중요하다고 생각했지만, <br> 팀원들과 소통하면서 step by step으로 프로젝트를 진행하면서 어떤 프로젝트도 개인 혼자서 <br> 다 만들 수 없다는 것을 팀원간의 협업을 통해 깨달았습니다. |
